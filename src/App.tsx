...
function App() {
  ...
  return (
    <div className="min-h-screen bg-b3-beige">
      {/* B3 Header med turquoise accent */}
      <div className="bg-white border-b-4 border-b3-turquoise shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center gap-4 mb-2">
            <div className="bg-b3-turquoise text-white font-bold text-3xl px-4 py-2 rounded-b3">
              b3
            </div>
            <div>
              <h1 className="text-4xl font-bold text-b3-grey">
                Förmånsbilskalkylator
              </h1>
              <p className="text-b3-grey-light text-sm italic">
                Creating possibilities together
              </p>
            </div>
          </div>
          <p className="text-b3-grey mt-2">
            Jämför total ägandekostnad för förmånsbilar enligt B3s RAM-modell
          </p>
        </div>
      </div>

      <div className="w-[90%] max-w-[1800px] mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-b3 shadow-xl p-8 overflow-visible">
          <div className="flex justify-between items-center mb-8">
            <div>
              <h2 className="text-2xl font-bold text-b3-grey">Dina bilar</h2>
              <p className="text-b3-grey-light mt-1">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-b3-turquoise hover:bg-b3-turquoise-dark text-white px-6 py-3 rounded-b3 transition-all shadow-md hover:shadow-lg font-semibold"
            >
              <Plus size={20} />
              Lägg till bil
            </button>
          ...
          {loading ? (
            <div className="text-center py-16">
              ...
              <p className="mt-4 text-b3-grey">Laddar bilar...</p>
            </div>
          ) : cars.length === 0 ? (
            <div className="text-center py-16 bg-b3-beige rounded-b3 border-2 border-dashed border-b3-grey-light">
              <div className="mb-4">
                <svg className="w-16 h-16 mx-auto text-b3-grey-light" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                </svg>
              </div>
              <p className="text-b3-grey mb-4 font-medium">Inga bilar tillagda ännu.</p>
              <button
                onClick={() => {
                  setEditingCar(null)
                  setIsModalOpen(true)
                }}
                className="bg-b3-turquoise hover:bg-b3-turquoise-dark text-white px-6 py-3 rounded-b3 font-semibold transition-all shadow-md hover:shadow-lg"
              >
